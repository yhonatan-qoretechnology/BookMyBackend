    ...
    translations: [
      {
        ...
        description: 'Manicura con esmaltado semipermanente y tratamiento SPA',
      },
      {
        language: 'en',
    ...
    translations: [
      {
        ...
        description: 'Manicura semipermanente con diseño francés y acabado SPA',
      },
      {
        language: 'en',
    ...
    translations: [
      {
        ...
        description: 'Pedicura con esmaltado semipermanente y tratamiento SPA',
      },
      {
        language: 'en',
    ...
    translations: [
      {
        language: 'es',
        name: 'Refuerzo AIB',
        description: 'Refuerzo de uñas con técnica AIB para mayor durabilidad',
      },
      {
        language: 'en',
    ...
    translations: [
      {
        ...
        description: 'Pedicura con aplicación de uñas en acrílico o polygel',
      },
      {
        language: 'en',
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        ...
        description: 'Small laser areas like armpits, upper lip, hands, etc',
      },
    ],
    prices: [{ amount: 6, duration: 10, currency: 'EUR' }],
    sedeIds: [1, 4],
    ...
    translations: [
      {
        language: 'es',
        name: 'Pedicura Esmaltado tradicional SPA',
        description: 'Tratamiento completo de pies con esmaltado tradicional',
      },
      {
        language: 'en',
        name: 'SPA Traditional Pedicure',
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        language: 'en',
        name: 'Jelly Semi-Permanent Pedicure',
        description: 'Pedicure with semi-permanent polish and jelly treatment',
      },
    ],
    ...
    translations: [
      {
        language: 'es',
        name: 'Implementos de asepsia',
        description: 'Elemento desechable para clientes con hongo o infección',
      },
      {
        language: 'en',
        name: 'Asepsis tools',
        description: 'Disposable tools for clients with fungus or infection',
      },
    ],
    prices: [{ amount: 3, duration: 5, currency: 'EUR' }],
    sedeIds: [2],
    ...
    translations: [
      {
        ...
        description: 'Extensiones de pestañas técnica clásica (pelo a pelo)',
      },
      {
        language: 'en',
        name: 'Classic Lashes',
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        ...
        description: 'Deep facial cleansing with intensive hydration treatment',
      },
    ],
    ...
    translations: [
      {
        ...
        description: 'Depilación con cera en zona de la espalda para hombre',
      },
      {
        language: 'en',
    ...
    translations: [
      {
        ...
        description: 'Lavado para cabello de longitud media con secado oreado.',
      },
      {
        language: 'en',
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        language: 'en',
        name: 'Hair Wash',
        description: 'Wash with Kerastase products and hair massage included.',
      },
    ],
    prices: [{ amount: 10, duration: 20, currency: 'EUR' }],
    sedeIds: [3],
  },
  {
    ...
    translations: [
      ...
      },
      {
        ...
        description: 'Intensive moisturizing treatment to restore hair health.',
      },
    ],
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        ...
        description: 'Customized Kerastase treatment for specific hair needs.',
      },
    ],
    ...
    translations: [
      {
        language: 'es',
        name: 'Cargo Extra',
        description: 'Cargo adicional por servicios o productos especiales.',
      },
      {
        language: 'en',
        name: 'Extra Charge',
...

  {
    ...
    translations: [
      ...
      },
      {
        ...
        description: 'Maintenance and refill for 2D and 3D eyelash extensions.',
      },
    ],
    prices: [{ amount: 51, duration: 120, currency: 'EUR' }],
    sedeIds: [4],
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        ...
        description: 'Refill service to maintain the Russian volume effect.',
      },
    ],
    prices: [{ amount: 61, duration: 135, currency: 'EUR' }],
    sedeIds: [4],
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        language: 'en',
        name: 'Lash Tint',
        description: 'Specific tint application to highlight the eyelashes.',
      },
    ],
...

  {
    ...
    translations: [
      ...
      },
      {
        language: 'en',
        name: 'Eyebrow Threading',
        description: 'Eyebrow shaping and cleaning using threading technique.',
      },
    ],
    prices: [{ amount: 12, duration: 15, currency: 'EUR' }],
    sedeIds: [4],
